    ...
    <div class="card position-relative">
        ...
        <div class="card-body">
            <form method="post">
                ...
                Nazwa:<input value="${user.userName}" name="userName" type="text" class="form-control" id="userName" placeholder="Nazwa użytkownika"><br>
                Email: <input value="${user.email}" name="userEmail" type="email" class="form-control" id="userEmail" placeholder="Email użytkownika"><br>
